...
import ar.org.centro8.java.web.repositories.list.ClienteRepositoryFactory;
...
//        }
        ...
        System.out.println("****Lista de clientes con documento '8899...'****");
        cr.getLikeNumeroDocumento("889").forEach(System.out::println);
    }
